...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="**:data-[slot=command-input-wrapper]:h-14 [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:font-500 [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-3 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-12 items-center gap-3 border-b border-md-outline-variant px-4"
    >
      <SearchIcon className="size-4 shrink-0 text-md-on-surface-variant" />
