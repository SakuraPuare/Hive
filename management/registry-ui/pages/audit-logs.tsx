                ...
                {loading ? (
                  ...
                  logs.map((l) => (
                    <TableRow key={l.id}>
                      ...
                      <TableCell className="text-muted-foreground text-sm">{l.detail || t.noData}</TableCell>
                      <TableCell className="text-muted-foreground text-xs font-mono">{l.ip || t.noData}</TableCell>
                    </TableRow>
                  ))
                )}
              </TableBody>
